...
# In line 7, is defined a function named "product()", is responsible of request to the user the product name
...
# In line 19, is defined a function named "price()", is responsible of request to the user the product price
...
dictionary= {
        ...
        "producto_amount":amount_variable,
        "total": total_amount
    }
...
#This script displays the product list, with all the entered inventory items.
print(f"\n\***INVENTORY*** \n{product_list}")

#con un for recorro la lista y la puedo enumerar